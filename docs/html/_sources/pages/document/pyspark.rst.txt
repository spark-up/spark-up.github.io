PySpark
=======
To scale the base featurization step, we reimplement the SortingHat base 
...
(figure 2). We use a dictionary to loop through and extract descriptive 
statistic features using 𝑝𝑦𝑠𝑝𝑎𝑟𝑘.𝑠𝑞𝑙.𝑓𝑢𝑛𝑐𝑡𝑖𝑜𝑛𝑠. This is done while 
simultaneously iterating through the entire dataset. The second scan 
obtains the 5 sample values. This scan will iterate through the dataset 
and obtain 5 distinct values to use as our sample values.